...
public class MultiPurposeFilter {
    ...
    public void build(){
        File stopwordPath = new File("src/com/resources/stopwordList/stopwords_en.txt");
        try{
    ...
    public void save(){
        try {
            FileOutputStream fos = new FileOutputStream("src/com/savedStopwordList/serializedStopword.txt");
    ...
    public HashSet<String> load(){
        File serializedStopWordPath = new File("src/com/savedStopwordList/serializedStopword.txt");
